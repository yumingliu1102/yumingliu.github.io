...
## 🔥 News
- 2025.11: 🎉 Created a new home page.

## 📝 Selected Publications
- **Yuming Liu**, Shan Ai*, Zhili Zhou*, Wei Pang, Changyu Dong, Huilin Ge, Daizhi Liao, Yongfeng Huang. *Image Copyright Dual-Protection Based on Extractable and Imperceptible Adversarial Watermark*. Big Data Mining and Analytics, 2025. (中科院一区TOP, accepted)
-  Chengsheng Yuan, Baojie Cui, Zhili Zhou, **Yuming Liu**, Yimin Yang, M. Jonathan Wu. [*RTRGAN: Ridge Texture Rendering Based Generative Adversarial Fingerprint Attack for Portable Consumer Electronics Devices*](https://ieeexplore.ieee.org/abstract/document/10542413/). IEEE Transactions on Consumer Electronics, 2024. (SCI Q1)
-  Gaofeng Zhu, Zhiguo Qu, Le Sun, **Yuming Liu**, Jianfeng Yang. [*Realistic real-time processing of anime portraits based on generative adversarial networks*](https://link.springer.com/article/10.1007/s11554-024-01481-1). Journal of Real-Time Image Processing, 2024. (SCI Q2)
...
- 2023.12: **National Third Prize**, China Collegiate Computing Contest (C4)
